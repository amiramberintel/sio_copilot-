# Wrapper: source this file in your PT session to start the server for corner: func.min_high
# Usage (inside pt_shell):
#   source /path/to/testCSPT/source_func.min_high.tcl

set pt_server_project "gfcn2clienta0"
set pt_server_type    "bu_prp"
set pt_server_corner  "func.min_high.T_85.typical"
